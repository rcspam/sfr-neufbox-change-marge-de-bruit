...
NOISE_RATE="$1"
CREDENTIALS="$HOME/bin/neufbox_change_bruit/.credentials"
IP="192.168.1.1"
PHANTOM="$HOME/bin/neufbox_change_bruit/phantomjs-1.9.7-linux-x86_64/bin/phantomjs"
TMP="$HOME/bin/neufbox_change_bruit//tmp"
COOKIES_FILE="$TMP/cookies"
TEMPLATES_DIR="$HOME/bin/neufbox_change_bruit/templates"
